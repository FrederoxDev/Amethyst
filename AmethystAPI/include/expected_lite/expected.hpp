// BEGIN AMETHYST MODIFICATION
// expected_lite defafults to using std::exception in modern c++ versions
// We don't want this to happen in our case to properly match memory in mc
#ifndef nsel_HAVE_STD_EXPECTED 
#define nsel_HAVE_STD_EXPECTED 0
#endif
// END AMETHYST MODIFICATION
...
#define nsel_CPP20_OR_GREATER  0
#define nsel_CPP23_OR_GREATER  0
