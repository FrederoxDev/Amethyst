...
void mce::Mesh::renderMesh(mce::MeshContext* meshContext, const mce::MaterialPtr* materialPtr, const std::variant<std::monostate, mce::TexturePtr>* texture){
    // 1.20.72.1 - found by xref mce::Mesh::_renderMesh()
    using function = void(mce::Mesh::*)(mce::MeshContext*, const mce::MaterialPtr*, const std::variant<std::monostate, mce::TexturePtr>*);
