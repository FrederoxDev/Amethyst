...
void BlockTessellator::appendTessellatedBlock(Tessellator *tessellator, const Block *block) {
    using function = void(BlockTessellator::*)(Tessellator*, const Block*);
...
int64_t BlockTessellator::tessellateInWorld(Tessellator &tessellator, const Block &block, const BlockPos &pos, bool a5, bool a6) {
    using function = int64_t(__thiscall*)(BlockTessellator*, Tessellator&, const Block&, const BlockPos&, bool, bool);
    static auto func = reinterpret_cast<function>(SigScan("40 53 55 56 57 41 56 48 83 EC ? 80 79"));
    return func(this, tessellator, block, pos, a5, a6);
}
